...
class AddMember(BasePage):
    ...
    def fillin_character(self, name, phonenum):
        ...
        self.find_send((By.XPATH,'//*[contains(@resource-id,"b78") and @index="2"]'), name)
        self.find_click((By.XPATH, '//*[contains(@resource-id,"b8_") and @class="android.widget.RelativeLayout"]'))
        self.find_click((By.XPATH, '//*[contains(@resource-id,"elq") and @text="男"]'))
        self.find_send((By.XPATH,'//*[@text="手机号"]'), phonenum)
